    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try{
                ...
                String sName = jsonObj.getString("sName");
                String sEmail = jsonObj.getString("sEmail");
                String sPassword = jsonObj.getString("sPassword");
                Students students = new Students(sName, sEmail, sPassword);
                System.out.println(students);
                Boolean status = studentDao.saveStudent(students);
                if (status) {
